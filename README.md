...
Since the project was developed under the free trail of GCP and now it has run out of credits, I disabled the billing so some functions may not be available. Please see Images folder or this file for showcase and demo.mp4 so see demonstration of the product.
...
- PostgreSQL
## Showcase
![Demo Screenshot](Images/showcase1.PNG)
![Demo Screenshot](Images/showcase2.PNG)
![Demo Screenshot](Images/showcase3.PNG)
