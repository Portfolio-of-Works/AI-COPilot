...
Since the project was developed under the free trail of GCP and now it has run out of credits, I disabled the billing so some functions may not be available. Please see Images folder or this file for showcase.
